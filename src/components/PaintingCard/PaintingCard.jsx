...
const PaintingCard = ({ title, image, _id }) => {
    ...
    const isFavorite = user && user.favoritePaintings?.includes(_id)
        ...
        <Card className='mb-3 paintingCard'>
            ...
            <Card.Body className="d-flex flex-column">
                ...
                <div className="d-flex justify-content-between">
                    ...
                    {user && (
                        <button onClick={isFavorite ? handleRemoveFavorite : handleFavorite} className="btn btn-dark btn-sm fav-button">
